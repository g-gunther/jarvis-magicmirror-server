...
var events_route_1 = __importDefault(require("./routes/events.route"));
...
app.use(home_route_1.default.routes());
app.use(events_route_1.default.routes());
var server = app
    .listen(config_1.default.port, function () { return __awaiter(void 0, void 0, void 0, function () {
